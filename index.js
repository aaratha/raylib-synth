...
var ASM_CONSTS = {
 ...
 116687: () => { document.exitFullscreen(); },  
 116714: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116847: () => { return window.innerWidth; },  
 116873: () => { return window.innerHeight; },  
 116900: () => { if (document.fullscreenElement) return 1; },  
 116946: () => { return document.getElementById('canvas').width; },  
 116998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117066: () => { if (document.fullscreenElement) return 1; },  
 117112: () => { return document.getElementById('canvas').width; },  
 117164: () => { return screen.width; },  
 117189: () => { return window.innerWidth; },  
 117215: () => { return window.innerHeight; },  
 117242: () => { if (document.fullscreenElement) return 1; },  
 117288: () => { return document.getElementById('canvas').width; },  
 117340: () => { return screen.width; },  
 117365: () => { document.exitFullscreen(); },  
 117392: () => { if (document.fullscreenElement) return 1; },  
 117438: () => { return document.getElementById('canvas').width; },  
 117490: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117558: () => { document.exitFullscreen(); },  
 117585: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117643: () => { return screen.width; },  
 117668: () => { return screen.height; },  
 117694: () => { return window.screenX; },  
 117721: () => { return window.screenY; },  
 117748: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117801: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117872: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117929: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 118185: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 118256: () => { if (document.fullscreenElement) return 1; },  
 118302: () => { return window.innerWidth; },  
 118328: () => { return window.innerHeight; },  
 118355: () => { if (document.pointerLockElement) return 1; }
};
